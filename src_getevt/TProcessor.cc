...
void art::TProcessor::ListProcessors()
{
   ...
   for (Int_t iCls = 0; iCls != nCls; ++iCls)
   {
      ...
      if (name.BeginsWith("vector"))
         continue;
      if (name.BeginsWith("pair"))
         continue;
      if (name.BeginsWith("reverse"))
         continue;
      if (name.BeginsWith("map"))
         continue;
      if (name.BeginsWith("list"))
         continue;
